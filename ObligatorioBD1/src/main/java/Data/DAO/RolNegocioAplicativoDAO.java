...
public class RolNegocioAplicativoDAO {
    ...
    {
        RolNegocioAplicativoModel[] xRolNegocioAplicativoModel = null;
        ...
        try {
            ...
            int i = 0;
            while (rs.next()) {
                xRolNegocioAplicativoModel[i] = new RolNegocioAplicativoModel(Integer.parseInt(rs.getString(1)), Integer.parseInt(rs.getString(2)),Integer.parseInt(rs.getString(3)));
                i++;
            }
        ...
        return xRolNegocioAplicativoModel;
    }
}
